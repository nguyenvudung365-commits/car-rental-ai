...
export default function BookingPage() {
  ...
  useEffect(() => {
    ...
    axiosClient.post('/pricing/predict', { carId, startDate, endDate })
      .then(res => {
      ...
      <div className="booking-summary">
        <div className="booking-car-info">
          {car.images && car.images.length > 0 ? (
            <img
              src={car.images.find(i => i.isThumbnail)?.url || car.images[0].url}
          ...
          <div style={{ marginLeft: 20 }}>
            ...
            <p style={{ color: '#6b7280', margin: '4px 0' }}>{car.type} · {car.licensePlate}</p>
